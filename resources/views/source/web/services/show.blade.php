        ...
        <div class="container">
            ...
            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-{{ App\Helpers\ServiceHelper::getStatusColor($service->service_status) }} badge-lg">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $service->start_date ? Carbon\Carbon::parse($service->start_date)->format('d/m/Y H:i') : 'N/A' }}
                                            </td>
                                        </tr>
                                        @if ($service->end_date)
                                            <tr>
                                                <td><strong>Ngày kết thúc:</strong></td>
                                                <td>{{ Carbon\Carbon::parse($service->end_date)->format('d/m/Y H:i') }}
                                                </td>
                                            </tr>
                                        @endif
                                    </table>
                                    ...
                                    <table class="table table-borderless">
                                        @if ($service->next_due_date)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::parse($service->next_due_date)->format('d/m/Y H:i') }}
                                                </td>
                                            </tr>
                                        @endif
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($service->is_recurring)
                                                    <span class="badge badge-info">Có
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><strong>Danh mục:</strong>
                                            {{ $service->parentProduct->category->name ?? 'N/A' }}</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><strong>Mã đơn hàng:</strong>
                                                    @if ($orderItem->order)
                                                        <a
                                                            href="{{ route('customer.order.detail', $orderItem->order->id) }}">
                                            ...
                                            <div class="col-md-6">
                                                <p><strong>Giá đặt hàng:</strong>
                                                    {{ number_format($orderItem->total ?? 0, 0, ',', '.') }} đ</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            @if (isset($serviceInfo['created_from_order']))
                                                <p><strong>Được tạo từ đơn hàng:</strong>
                                                    #{{ $serviceInfo['created_from_order'] }}</p>
                                            @endif
                                            @if (isset($serviceInfo['provisioned_at']))
                                                <p><strong>Ngày cung cấp:</strong>
                                                    {{ Carbon\Carbon::parse($serviceInfo['provisioned_at'])->format('d/m/Y H:i') }}
                                                </p>
                                            @endif
                                        </div>
                                        <div class="col-md-6">
                                            @if (isset($serviceInfo['duration_years']))
                                                <p><strong>Thời hạn ban đầu:</strong> {{ $serviceInfo['duration_years'] }}
                                                    năm</p>
                                            @endif
                                            @if (isset($serviceInfo['original_product_id']))
                                                <p><strong>ID sản phẩm gốc:</strong>
                                                    #{{ $serviceInfo['original_product_id'] }}</p>
                                            @endif
                                        </div>
                                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        <div
                            class="card-header bg-{{ App\Helpers\ServiceHelper::getStatusColor($service->service_status) }} text-white">
                            <h5 class="m-0">
                                <i class="fa fa-info-circle"></i>
                                Trạng thái
                            </h5>
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <span
                                    class="badge badge-{{ App\Helpers\ServiceHelper::getStatusColor($service->service_status) }} badge-lg mb-3">
                                    {{ ucfirst($service->service_status) }}
                                </span>
                    ...
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            <tr>
                                ...
                                <td>{{ $provisionData['server_ip'] ?? 'N/A' }}</td>
                            </tr>
                            <tr>
                                <td><strong>Username:</strong></td>
                                <td>{{ $provisionData['username'] ?? 'N/A' }}</td>
                            </tr>
                            <tr>
                                <td><strong>Port:</strong></td>
                                <td>{{ $provisionData['port'] ?? 'N/A' }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <table class="table table-borderless">
                            <tr>
                                ...
                                <td>{{ $provisionData['os'] ?? 'N/A' }}</td>
                            </tr>
                            <tr>
                                <td><strong>Status:</strong></td>
                                <td><span class="badge badge-success">{{ $provisionData['status'] ?? 'Active' }}</span>
                                </td>
                            </tr>
                            <tr>
